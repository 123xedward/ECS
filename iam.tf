...
resource "aws_iam_role" "ec2_instance_role" {
  ...
  name               = "EcsCluster${var.ecs_name}Ec2InstanceRole"
  tags               = var.iam_tags
}
...
resource "aws_iam_instance_profile" "ecs_node" {
  name = "EcsCluster${var.ecs_name}Ec2InstanceProfile"
  role = aws_iam_role.ec2_instance_role.name
}
...
resource "aws_iam_role" "ecs_service_role" {
  ...
  name               = "EcsCluster${var.ecs_name}ServiceRole"
  tags               = var.iam_tags
}
...
resource "aws_iam_role" "ecs_task_role" {
  ...
  name               = "EcsCluster${var.ecs_name}DefaultTaskRole"
  tags               = var.iam_tags
}
